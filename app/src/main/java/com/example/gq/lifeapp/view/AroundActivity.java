...
public class AroundActivity extends BaseActivity {
    ...
    private void showLocation(Location mLocation) {
        ...
        mapURL = "http://m.amap.com/around/?locations="+longitude+","+latitude+"&keywords=美食,KTV,地铁站,公交站&defaultIndex=3&defaultView=&searchRadius=5000&key=5bfe6d9bd868ed669fdf7e7848939154";
